...
public static class PasswordEndpoints
{
    ...
    private static async Task<Results<Ok, BadRequest, BadRequest<List<FluentValidation.Results.ValidationFailure>>>> RegisterEndpoint<TUser>(
    ...
    private static async Task<Results<Ok, BadRequest, BadRequest<List<FluentValidation.Results.ValidationFailure>>>> SendConfirmationEndpoint<TUser>(
    ...
    private static async Task<Results<BadRequest, Ok<GenerateTokenResult>, BadRequest<GenerateTokenResult>>> 
